...
func _on_settings_pressed():
	...
	# Not applicable in VR. If we retrofit this into the non VR version we'll need to make this switchable
	# hence I'm not removing the code and hiding the fields
